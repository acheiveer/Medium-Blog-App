import { signupInput } from "@prabhakr4u/medium-common";
        ...
        <div className="h-screen flex justify-center flex-col">
            <div className="flex justify-center">
                <div>
                    ...
                    <div className="pt-8">
                        {type==="signup"? <LabelledInput label="Name" placeholder="Prabhakar Singh.." onChange={(e) => {
                            setPostInputs({
                                ...postInputs,
                                name: e.target.value
                            })
...
function LabelledInput({ label, placeholder, onChange, type }: LabelledInputType) {
    return (
        <div>
            <label className="block mb-2  text-sm font-bold pt-4 text-gray-900 dark:text-white">{label}</label>
